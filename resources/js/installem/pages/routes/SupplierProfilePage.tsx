            ...
            <>
              ...
              <HistoryTable
                ...
                rows={ledger.map((l) => [
                  ...
                  l.isAdvanceApplied
                    ? <Badge key="t" tone="primary">↓ Advance Applied</Badge>
                    : l.isAdvanceRecredit
                    ? <Badge key="t" tone="success">↑ Advance Re-credited</Badge>
                    : l.type === "Advance Paid"
            ...
            <div className="rounded-lg border border-border p-3 mt-2">
              ...
              {crossesTarget && (
                <div className="mt-2 text-[11px] text-success-foreground bg-success/15 rounded px-2 py-1.5 font-medium">
                  ✓ This order crosses the target — unlocks reward: <b>{annual.reward}</b>
                </div>
              )}
            </div>
          )}

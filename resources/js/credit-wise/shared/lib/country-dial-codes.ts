...
// Sourced from the free dr5hn countries dataset and trimmed to a reusable
// app-local dial-code list for phone/mobile fields.
export const DEFAULT_COUNTRY_DIAL_CODE = "+92";

...
import { fmtDate, addMonths, type Cheque, type Guarantor } from "@/components/system/support/shared";

const StepCustomer    = lazy(() => import("@/components/system/support/StepCustomer"));
const StepProduct     = lazy(() => import("@/components/system/support/StepProduct"));
const StepPricing     = lazy(() => import("@/components/system/support/StepPricing"));
const StepSchedule    = lazy(() => import("@/components/system/support/StepSchedule"));
const StepCheques     = lazy(() => import("@/components/system/support/StepCheques"));
const StepGuarantors  = lazy(() => import("@/components/system/support/StepGuarantors"));
const StepReview      = lazy(() => import("@/components/system/support/StepReview"));
...
export function NewHpCaseWizard({ onClose, titleOverride, subtitlePrefix }: {
  ...
  const steps: WizardStep[] = [
    { key: "customer", title: "Customer", description: "Pick or add a customer",
      ...
      preload: () => import("@/components/system/support/StepCustomer"),
    ...
    { key: "product", title: "Product", description: "Variant & quantity",
      ...
      preload: () => import("@/components/system/support/StepProduct"),
    ...
    { key: "pricing", title: "Pricing", description: "Price, down & tenure",
      ...
      preload: () => import("@/components/system/support/StepPricing"),
    ...
    { key: "schedule", title: "Schedule", description: "Installment plan",
      ...
      preload: () => import("@/components/system/support/StepSchedule"),
    ...
    { key: "cheques", title: "Cheques", description: "Bank cheque details",
      preload: () => import("@/components/system/support/StepCheques"),
    ...
    { key: "guarantors", title: "Guarantors", description: "References & co-signers",
      preload: () => import("@/components/system/support/StepGuarantors"),
    ...
    { key: "review", title: "Review", description: "Confirm & save",
      preload: () => import("@/components/system/support/StepReview"),

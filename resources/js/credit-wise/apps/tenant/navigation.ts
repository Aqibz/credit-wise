...
export const TENANT_NAV_SECTIONS: NavigationSection[] = [
  {
    title: "Overview",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Deliveries", to: "/logistics/deliveries", icon: Truck },
      ...
      { label: "Sales Returns", to: "/sales/returns", icon: ShoppingBag },
    ],
  },
  {
    title: "Purchases",
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Stock Center", to: "/inventory/stock-center" },
      ...
      { label: "Goods Receipt Notes", to: "/purchases/grn", icon: Package },
    ...
    items: [
      ...
      { label: "Integration Hub", to: "/settings/integrations", icon: Plug },
      {
        ...
        children: [
          ...
          { label: "Master Settings", to: "/settings" },
        ],
      },
    ],
  },
